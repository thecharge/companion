...
const IntegrationsSchema = z.object({
  slack: z
    .object({
      ...
      trusted_user_ids: z.array(z.string()).default([]),
      trusted_channel_ids: z.array(z.string()).default([]),
      trusted_team_ids: z.array(z.string()).default([]),
  ...
  telegram: z
    .object({
      ...
      trusted_user_ids: z.array(z.coerce.number().int()).default([]),
      trusted_chat_ids: z.array(z.coerce.number().int()).default([]),
      required_passphrase: z.string().optional(),
      mode: z.string().optional(),
